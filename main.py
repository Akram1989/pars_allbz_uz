...
#починить продукт дескрипшн если на листе его нет дает ошибку функция try except должна сработать
#добавить маржу
# создать функцию для прописи в json или csv чтобы 1 раз сделать и дальше все прописывалось само - пока пишет только 1 шт